...
export default function Navbar() {
  ...
  const NavLink = ({
    ...
    <Link
      to={href}
      className="group relative text-white text-base font-medium hover:text-purple-600"
    >
      {children}
  ...
  return (
    <>
      <div className="mx-auto px-4 py-4 flex justify-between items-center bg-black">
        <button
